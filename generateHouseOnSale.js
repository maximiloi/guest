...
const arrayHouses = [
    {
        ...
        "landArea": "5 соток",
        "address": "Ейское шоссе,<br> КП Ясенево,<br> ул. Романовская, 4",
    }, {
        "id": "house-110m",
...
} else if (idPage.id === 'reviews' || idPage.id === 'onorder' || idPage.id === 'about' || idPage.id === 'index' || idPage.id === 'faq') { // поиск для работы на странице Отзывы reviews.php или Дома на заказ order.php или о компании company.php
